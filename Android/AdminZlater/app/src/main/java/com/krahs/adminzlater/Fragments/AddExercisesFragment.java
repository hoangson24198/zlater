...
import com.krahs.adminzlater.Adapter.SpinnerBodyPartsAdapter;
import com.krahs.adminzlater.Adapter.SpinnerLevelAdapter;
...
//        saveImage();
        ...
        for (int i = 0; i < bodypartsList.size(); i++) {
            Log.e("HS::", "list:::" + bodypartsList.size());
            Log.e("HS::", "bodyparts ::: " + bodypartsList.get(i).isChecked());
