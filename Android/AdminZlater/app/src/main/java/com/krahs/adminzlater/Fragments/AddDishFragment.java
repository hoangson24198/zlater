...
import com.krahs.adminzlater.Adapter.SpinnerIngredientApdapter;
import com.krahs.adminzlater.Adapter.SpinnerMealsAdapter;
...
public class AddDishFragment extends DialogFragment implements View.OnClickListener {
    ...
    private void handleAddDish() {
        ...
        for (int i = 0; i < ingredientsList.size(); i++) {
            Log.e("HS::", "list:::" + listIdIngredient.size());
            Log.e("HS::", "bodyparts ::: " + ingredientsList.get(i).isChecked());
            if (ingredientsList.get(i).isChecked()) {
                listIdIngredient.add(ingredientsList.get(i).getIdIngredients());
                Log.e("HS::", "id ingredient" + ingredientsList.get(i).getIdIngredients());
            }
        }
        ...
        adminPolyfitServices.getAllMeals().enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.isSuccessful()) {
                    ...
                    Log.e("HS:::::ListMeals", /*exercisesList.get(0).getId() +*/":: Success ::" + array);
                }
            }
